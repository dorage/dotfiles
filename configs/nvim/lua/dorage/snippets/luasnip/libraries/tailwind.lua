...
ls.add_snippets("javascript", className)
ls.add_snippets("javascriptreact", className)

ls.add_snippets("typescript", className)
ls.add_snippets("typescriptreact", className)
